...
$sql = "SELECT * FROM t002_equipos WHERE id_equipo  LIKE '".$busqueda."' OR placa LIKE '" . $busqueda."'";
...
$sql = "SELECT * FROM t003_plan_mantenimiento WHERE id_equipo  LIKE '".$id_equipo."' ";
